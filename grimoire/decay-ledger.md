...
| Drive a conjuration through a daemon + thin CLI        | active       | 2026-06-15      | grapevine + imago independently converged (cli.ts + `/cmd`+`/state`+`/events?since=` + snapshot/restore); bounty-agent-usable adopts it |
