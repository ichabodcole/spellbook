...
| Drive a conjuration through a daemon + thin CLI        | active       | 2026-06-15      | grapevine + imago independently converged; bounty-agent-usable shipped it (first full adopter); scenario: readback-parity (`state` must reach surface parity, not raw fields)                                                     |
