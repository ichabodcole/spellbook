...
| ------------------------------------------------------ | ------------ | --------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Architect for the reader's context                     | perennial    | 2026-06-15      | glamour SKILL isolation pass; grapevine V1.7 soak; bounty fresh-agent (cold workers hit the readback gap — `state` pushed as orient/confirm but unscoped + un-computed → readback-parity) |
