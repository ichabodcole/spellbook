...
| `style-archive <id> [--unarchive]`                                                                                 | Archive (or `--unarchive`) a saved style from the tray                                                                                                                                                                                                                                                                                     |
...
| `schema`                                                                                                           | Emit this CLI's acc declaration (format v0, `provenance: emitted`), walked from the same command table that dispatches — `acc check <cli.ts> --declaration <(cli.ts schema)`                                                                                                                                                               |
