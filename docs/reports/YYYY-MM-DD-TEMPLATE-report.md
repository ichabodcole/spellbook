...
- **Date:** YYYY-MM-DD
- **Report Type:** [Doc Status / Code Review / Security Audit / Performance
  Analysis / Dependency Audit / Architecture Assessment / Other]
...
- **Related Projects:**
  [Link to relevant project proposals](../projects/project-name/proposal.md)
