...
import type { ClientToServer } from "../../../../plugins/spellbook/skills/imago/shared/types";
  ...
  return (
    <div className="px-6 py-3 flex items-center justify-between border-t border-divider">
      <span className="text-faint">
        hit a snag, or something feel off? tell the agent — that's how imago gets better.
      </span>
